...
PromptAmpGain='Amplifier Voltage @ 1kHz?:';
...
%Read in data for the frequency dependence of the Amplifier
%%%%AmpFileID=fopen('AmpData.txt','r');
%%%%AmpFormatSpec='%f';
%%%%AmpTempData=fscanf(AmpFileID,AmpFormatSpec);
%%%%AmpFreqVolt=1:2200;
%%%%for i=1:2200
%%%%    AmpFreqVolt(i)=AmpTempData(2*i);
%%%%end
...
SampleType='500 Micrometer PDMS Plates Around HYD';
SampleInfo='TEST';
AmpGain='40';
...
FileHeaderA={'Date' 'Time' 'SampleType' 'SampleInfo' 'Vpp(FG)' 'AmplifierGain' 'WaveType' 'dt'};
FileHeaderB={DateString TimeString SampleType SampleInfo num2str(Vpp) AmpGain WaveType num2str(dt)};
